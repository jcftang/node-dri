 ...
 */
exports.update = function save(data, files, onSuccess,  onError) {
	var items = getDatabaseCollection("series")
...
exports.getSeriesItemsByID = function getSeriesItemsByID(id, callback) {
	var series = getDatabaseCollection("series")
...
exports.getDatabaseCollection = function(data) {
	return getDatabaseCollection(data)
};
