...
exports.createItem = function(data, onSuccess, onError) {
 ...
 ID of the newly created item
 */
exports.addItemToSeries = function(itemId, seriesId, onSuccess, onError) {

	mongoose.connect('mongodb://localhost/dri');

	this.getItem(itemId, function(item) {
		this.getSeries(seriesId, function(series) {
			console.log(series)
...
exports.removeItem = function(id, onSuccess, onError) {
	...
	mongoose.connect('mongodb://localhost/dri');
	schemas.driItem.remove(id, function(err, msg) {
		if(err) {
			onError(err)
		} else {
			onSuccess(msg)
...
exports.removeSeries = function(id, onSuccess, onError) {
	...
	mongoose.connect('mongodb://localhost/dri');
	schemas.driSeries.remove(id, function(err, msg) {
		if(err) {
			onError(err)
		} else {
			onSuccess(msg)
...
exports.removeCollection = function(id, onSuccess, onError) {
	...
	mongoose.connect('mongodb://localhost/dri');
	schemas.driCollection.remove(id, function(err, msg) {
		if(err) {
			onError(err)
		} else {
			onSuccess(msg)
